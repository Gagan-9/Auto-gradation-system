...
},
{
  ...
  "inputFormat": "The first line contains an integer n (the number of elements). The second line contains n space-separated integers.",
  "outputFormat": "Return indices of the two numbers such that they add up to a specific target.",
  "sampleInput": "4\n2 7 11 15",
  "sampleOutput": "0 1",
  "likes": 123,
  "dislikes": 10,
  ...
  "starterCode": "function twoSum(nums, target) { /* your code */ }",
  "difficulty": "Easy",
  "solution": "You can use a hashmap to store the complement of each number as you iterate through the array.",
  "videoId": "abcd1234",
  "testCases": [
    {
      "input": ["4", "2 7 11 15"],
