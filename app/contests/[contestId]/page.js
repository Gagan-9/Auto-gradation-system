...
const page = () => {
  ...
  return (
    ...
    <div className="w-full flex flex-col gap-5 max-w-6xl mx-auto px-2 mt-3 mb-10">
      ...
      <div className="flex gap-5 max-md:flex-col max-md:items-center text-white">
        <div className="flex-grow">
          ...
          <div className="bg-light-3 rounded-r-full pl-4 pr-10 py-4 mb-5 w-fit text-black">
        ...
        <div className="w-full max-w-[300px] bg-light-2 rounded-lg h-fit shadow-lg pb-2 text-black">
      ...
      {!isUpcoming && (
        <div className="mt-10 flex items-start gap-5 max-md:flex-col text-white">
          <div className="w-full border border-light-3 rounded-lg hover:shadow-lg transition-all">
            <div className="bg-light-3 flex justify-between items-center px-4 py-2.5 rounded-t-lg">
              <p className="font-medium max-xs:text-sm text-black">Problem list</p>
              <p className="font-medium max-xs:text-sm text-black">Score</p>
            </div>
          ...
          <div className="w-full border border-light-3 rounded-lg hover:shadow-lg transition-all text-black">
            ...
            <div className="hover:bg-green-500 text-center rounded-b-lg flex">
              <Link 
