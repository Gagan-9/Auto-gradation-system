...
const page = () => {
  ...
  return (
    <>
      <div className="w-full min-h-[90vh] max-w-full flex flex-col gap-10 px-2 mx-auto pt-10 pb-20 bg-black text-white">
        <div className="text-center justify-center">
          <h1 className="font-medium mb-3">Create an Interview</h1>
          <div className="flex gap-10 flex-wrap justify-center">
            <Link
              href="/interview/peer-graded"
              className="w-[300px] flex flex-col items-center gap-2 text-white rounded-3xl shadow-xl bg-green-700 py-14 text-center hover:bg-blue-600 hover:scale-[1.03] transition-all ease-in"
            >
              <img
                src="/p2p.png"
                alt="p2p"
        ...
        <div className="flex flex-col items-center justify-center">
          <h1 className="font-medium mb-3 text-center">Past Interviews</h1>
                ...
                >
                  ...
                  <p>
                    ...
                    {`Submitted: ${formatDateTime(
                      new Date(interview.submissionTime)
                    )}`}
                  </p>
                </div>
              ))
            ) : (
              <p className="text-gray-2 text-center">No interviews found</p>
            )}
          </div>
        </div>
        </div>
        ...
        <div>
        <div className="flex flex-col items-center justify-center">
          <h1 className="font-medium mb-3 text-center">Assigned Interviews</h1>
          <div className="w-full flex gap-10 flex-wrap justify-center">
            {assignedInterviews &&
                ...
                >
                  ...
                  <p>
                    ...
                    {`Deadline: ${deadlineFormat(
                      new Date(
                        new Date(
                          assignedInterviews.assignedTime[index]
                        ).getTime() +
                          2 * 24 * 60 * 60 * 1000
                      )
                    )}`}
